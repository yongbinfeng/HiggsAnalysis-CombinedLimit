...
// Header file for class GSLMultiMinFunctionAdapterMod
//
...
//
#ifndef ROOT_Math_GSLMultiMinFunctionAdapterMod
#define ROOT_Math_GSLMultiMinFunctionAdapterMod
...
namespace Math {
  ...
  */
  ...
  struct  GSLMultiMinFunctionAdapterMod {
...
#endif /* ROOT_Math_GSLMultiMinFunctionAdapterMod */
