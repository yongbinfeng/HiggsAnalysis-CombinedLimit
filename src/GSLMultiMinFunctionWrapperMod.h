...
// Header file for class GSLMultiMinFunctionWrapperMod
//
// Created by: moneta  at Sat Nov 13 14:54:41 2004
//
// Last update: Sat Nov 13 14:54:41 2004
//
#ifndef ROOT_Math_GSLMultiMinFunctionWrapperMod
#define ROOT_Math_GSLMultiMinFunctionWrapperMod

#include "gsl/gsl_multimin.h"

#include "GSLMultiMinFunctionAdapterMod.h"
...
class GSLMultiMinFunctionWrapperMod {

public:

   GSLMultiMinFunctionWrapperMod()
   {
      fFunc.f = 0;
      fFunc.n = 0;
      fFunc.params = 0;
   ...
   void SetFunction(const FuncType &f) {
      const void * p = &f;
      assert (p != 0);
      SetFuncPointer(&GSLMultiMinFunctionAdapterMod<FuncType >::F);
      SetDim( f.NDim() );
 ...
 */
 ...
 public:
    ...
    void SetFunction(const FuncType &f) {
       ...
       assert (p != 0);
       SetFuncPointer(&GSLMultiMinFunctionAdapterMod<FuncType >::F);
       SetDerivPointer(&GSLMultiMinFunctionAdapterMod<FuncType >::Df);
       SetFdfPointer(&GSLMultiMinFunctionAdapterMod<FuncType >::Fdf);
       SetDim( f.NDim() );
       SetParams(const_cast<void *>(p));
     }
...
#endif /* ROOT_Math_GSLMultiMinFunctionWrapperMod */
