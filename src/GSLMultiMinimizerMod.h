...
// Header file for class GSLMultiMinimizerMod

#ifndef ROOT_Math_GSLMultiMinimizerMod
#define ROOT_Math_GSLMultiMinimizerMod

#include "gsl/gsl_vector.h"
#include "gsl/gsl_multimin.h"
#include "gsl/gsl_version.h"
#include "GSLMultiMinFunctionWrapperMod.h"
...
/**
   GSLMultiMinimizerMod class , for minimizing multi-dimensional function
   using derivatives
...
#else
         MATH_INFO_MSG("GSLMultiMinimizerMod","minimizer BFSG2 does not exist with this GSL version , use BFGS");
         fType = gsl_multimin_fdfminimizer_vector_bfgs;
#endif
         break;
...
private:
   ...
   /**
      Copy constructor
   */
   GSLMultiMinimizerMod(const GSLMultiMinimizerMod &) {}

   /**
      Assignment operator
   */
   GSLMultiMinimizerMod & operator = (const GSLMultiMinimizerMod & rhs)  {
...
#endif /* ROOT_Math_GSLMultiMinimizerMod */
