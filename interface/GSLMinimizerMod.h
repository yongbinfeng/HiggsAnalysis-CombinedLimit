...
// Header file for class GSLMinimizerMod

#ifndef ROOT_Math_GSLMinimizerMod
...
/**
   ...
   @ingroup MultiMin
*/
class GSLMinimizerMod : public ROOT::Math::BasicMinimizer {
...
public:
   ...
   */
    ...
    */
   GSLMinimizerMod (const char *  type  );

   /**
      Destructor
   */
   virtual ~GSLMinimizerMod ();
...
private:
   ...
   /**
      Copy constructor
   */
   GSLMinimizerMod(const GSLMinimizerMod &) : BasicMinimizer() {}

   /**
      Assignment operator
   */
   GSLMinimizerMod & operator = (const GSLMinimizerMod & rhs) {
...
private:
   ...
   ROOT::Math::GSLMultiMinimizerMod * fGSLMultiMin;
...
#endif /* ROOT_Math_GSLMinimizerMod */
